...
Cg::User.create!(
  ...
  name: 'ペットショップパトラ',
  username: 'patora',
  icon: 'sample/person/woman_1.jpg',
...
Cg::User.create!(
  ...
  name: 'トライデント ダメ太郎',
  username: 'dame',
  icon: 'sample/person/woman_2.jpg',
